...
Post.find_or_create_by!(title: "初バレーボール観戦") do |one_post|
  one_post.images=ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.jpg"), filename:"sample-post1.jpg")
  one_post.body="楽しかった！"
  one_post.user="olivia"
end
...
Post.find_or_create_by!(title: "オリンピック") do |one_post|
  one_post.images=ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.jpg"), filename:"sample-post1.jpg")
